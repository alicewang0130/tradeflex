...
export default function CommunityPage() {
  ...
  const tr = {
    ...
    ja: {
      ...
      hot: '人気',
      new: '新着',
      searchTicker: 'ティッカーを検索...',
      newDiscussion: '新しいディスカッション',
      tickerPlaceholder: 'ティッカー（任意）',
      titlePlaceholder: 'タイトル — 何を考えてる？',
      contentPlaceholder: '分析、テーゼ、ホットテイクをシェアしよう...',
      posting: '投稿中...',
      postToCommunity: 'コミュニティに投稿 🚀',
      noDiscussions: 'まだディスカッションがありません',
      beFirst: '最初に会話を始めよう！🚀',
      comments: 'コメント',
      signInToComment: 'ログイン',
      toComment: 'してコメント',
    ...
    ko: {
      ...
      searchTicker: '티커 검색...',
      newDiscussion: '새 토론',
      tickerPlaceholder: '티커 (선택)',
      titlePlaceholder: '제목 — 무슨 생각이야?',
      contentPlaceholder: '분석, 의견, 핫테이크를 공유해봐...',
      posting: '게시 중...',
      postToCommunity: '커뮤니티에 게시 🚀',
      noDiscussions: '아직 토론이 없습니다',
      beFirst: '첫 번째로 대화를 시작해보세요! 🚀',
      comments: '댓글',
      signInToComment: '로그인',
      toComment: '후 댓글 작성',
    ...
    es: {
      ...
      newPost: 'Nuevo Post',
      signInToPost: 'Inicia sesión para postear',
      hot: 'Popular',
      new: 'Nuevo',
      searchTicker: 'Buscar ticker...',
      newDiscussion: 'Nueva Discusión',
      tickerPlaceholder: 'Ticker (opcional)',
      titlePlaceholder: 'Título — ¿qué tienes en mente?',
      contentPlaceholder: 'Comparte tu análisis, tesis o hot take...',
      posting: 'Publicando...',
      postToCommunity: 'Publicar en Comunidad 🚀',
      noDiscussions: 'Aún no hay discusiones',
      beFirst: '¡Sé el primero en iniciar una conversación! 🚀',
      comments: 'comentarios',
      signInToComment: 'Inicia sesión',
    ...
    fr: {
      ...
      signInToPost: 'Connecte-toi pour poster',
      hot: 'Populaire',
      new: 'Récent',
      searchTicker: 'Chercher un ticker...',
      newDiscussion: 'Nouvelle Discussion',
      tickerPlaceholder: 'Ticker (optionnel)',
      titlePlaceholder: 'Titre — qu\'est-ce qui te passe par la tête ?',
      contentPlaceholder: 'Partage ton analyse, ta thèse ou ton hot take...',
      posting: 'Publication...',
      postToCommunity: 'Publier dans la Communauté 🚀',
      noDiscussions: 'Pas encore de discussions',
      beFirst: 'Sois le premier à lancer une conversation ! 🚀',
      comments: 'commentaires',
      signInToComment: 'Connecte-toi',
